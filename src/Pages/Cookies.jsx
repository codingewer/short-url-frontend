...
function Cookies() {
  ...
  return (
    ...
    <div data-aos="fade-up"  className="contacus-page">
      ...
      <p>
        Biz, Linkamon, olarak güvenliğinize önem veriyor ve bu Çerez Politikası
        ile siz sevgili ziyaretçilerimizi, web sitemizde hangi çerezleri, hangi
        amaçla kullandığımız ve çerez ayarlarınızı nasıl değiştireceğiniz
      ...
      <p>
        ...
        sebebiyle, 6698 sayılı{" "}
        <a href="https://sartlar.com/kvkk-nedir">
          Kişisel Verilerin Korunması Kanunu
        </a>{" "}
        gereğince, kullanıcıların bilgilendirilmeleri ve onaylarının alınması
        gerekmektedir.
      </p>
      <p>
      ...
      <p>
        ...
        amaçları, ziyaretçilerin ihtiyaçlarına yönelik ilgilerini çekecek
        reklamların gösterilmesine yardımcı olmaktır ve sorumluluğu çerez sahibi
      ...
      <p>
        ...
        contact@linkamon.com e-mail adresi üzerinden iletişime geçebilirsiniz.
      </p>
      </div>
          </div>
        </div>
